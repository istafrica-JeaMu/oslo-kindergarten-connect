      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>45 completed applications</CardDescription>
            </div>
        ...
        <CardContent>
          <div className="text-center py-12 text-gray-500">
            ...
            <p className="text-lg font-medium mb-2">Submitted Applications</p>
            <p>This feature is coming soon. Completed applications will appear here.</p>
          </div>
        </CardContent>
      </Card>
    </div>
